...
async function main() {
  ...
  if (chainId !== 4201) {
    throw new Error(`ChainId non atteso: ${chainId}. Atteso 4201 (LUKSO Testnet). Interrotto.`);
  }
  ...
  // DEPLOY
  // =========================
  const Factory = await hre.ethers.getContractFactory("First10Purchases2026_V2");

  console.log("Deploying First10Purchases2026_V2...");
